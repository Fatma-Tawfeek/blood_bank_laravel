...
@endsection
  ...
  <!-- Default box -->
    <div class="card">
      ...
      <div class="card-body">
        <a href="{{url(route('governorates.create'))}}" class="btn btn-primary mb-2"><i class="fa fa-plus mr-2"></i>New Governorate</a>
        ...
        <div class="table-responsive">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$record->name}}</td>
                    <td class="text-center"><a href="{{url(route('governorates.edit',$record->id))}}" class="btn btn-success btn-sm"><i class="fa fa-edit mr-2"></i>Edit</a></td>
